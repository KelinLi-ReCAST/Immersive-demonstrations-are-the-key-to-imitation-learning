...
success_rate_force = np.load(os.getcwd()+"/data/training_results/f_pforce_ruth.npy")*3
success_rate_noforce = np.load(os.getcwd()+"/data/training_results/n_pforce_ruth.npy")
success_rate_panda = np.load(os.getcwd()+"/data/training_results/p_pforce_ruth.npy")/3
