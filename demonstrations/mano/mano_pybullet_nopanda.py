...
def main(demons_num, demonstrator, force_flag, glove_calibration, panda_flag):
    ...
    manoUid = p.loadURDF('/home/kelin/workspace_kelin/RAL-ICRA2023/GraspIt2URDF-master/urdf/HumanHand20DOF.urdf',basePosition=[0,0,1],baseOrientation=[0.707,0,0,0.707])
