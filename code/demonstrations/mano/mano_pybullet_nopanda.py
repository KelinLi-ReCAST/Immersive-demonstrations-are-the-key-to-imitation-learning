...
def main(demons_num, demonstrator, force_flag, glove_calibration, panda_flag):
    ...
    manoUid = p.loadURDF(os.path.join(REPO_DIR,'third_party','GraspIt2URDF-master','urdf','HumanHand20DOF.urdf'),basePosition=[0,0,1],baseOrientation=[0.707,0,0,0.707])
    ...
    while flag == True:
        try:
            ...
            utils.set_mano_position(manoUid, manoJointNameToID, manoJoints, hand_joints)
