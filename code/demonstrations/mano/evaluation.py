...
DATA_DIR = os.path.join(REPO_DIR, 'data', 'mano')
VIDEO_DIR = os.path.join(REPO_DIR, 'media', 'videos', 'mano')
import numpy as np
...
success_rate_force = np.load(DATA_DIR+"/training_results/f_pforce_mano.npy")
success_rate_noforce = np.load(DATA_DIR+"/training_results/n_pforce_mano.npy")
success_rate_panda = np.load(DATA_DIR+"/training_results/p_pforce_mano.npy")
